...
public class ProfessorDB implements ProfessorDBInterface {
    ...
    //static String space = "                                             ";
    //private static final Logger logger = Logger.getLogger(String.valueOf(ProfessorOperations.class));
    public ProfessorDB(){
    ...
    @Override
    public List<StudentPojo> getEnrolledStudentsDB(int courseId) {
        System.out.println("in prof db");

        System.out.println("in prof db after connection");
        ...
        try {
            ...
            while(rs.next()){
                StudentPojo student = new StudentPojo(rs.getInt(1),rs.getString(2));
